...
const CategoryHome = () =>{
    ...
    useEffect(()=>{
        let url = baseurl+'/api/stories/'+category+'/';
        if(subCategory != 'all'){
            url = baseurl+'/api/stories/'+category+'/'+subCategory;
        }
    ...
    const addToReadingList = (storyID) =>{
        if(user){
            axios.post(baseurl+'/api/reading-list-create/', {
                story: storyID,
                user: user.id
            }).then((resp)=>{
                console.log(resp.data)
    ...
    return(
        <>
            ...
            <div className='customContainer'>
                <h3 style={{marginLeft: '10px', color: '#012559'}}>{subCategory}</h3>
                {
                            ...
                            return(
                                <div className='row postDisplay align-items-center justify-content-around'>
                                    <div className='col-2 col-md-2 imageContainer'>
                                        <img src={baseurl+story.editor.photo} className='displayImg'/>
                                    </div>
                                    <div className='col-7 col-md-7 blogPart'>
                                        <h3 style={{color: '#012559'}}>{story.title}</h3>
                                        <br/>
                                        <p>{story.editor.bio}
                                    ...
                                    <div className='col-2 col-md-2 blogPart my-auto' style={{textAlign: 'center', color: '#012559'}}>
                                        <h4 style={{marginTop: '50px'}}>{story.editor.name}</h4>
                                    ...
                                    <div className='col-md-1'>
                                        ...
                                        >
                                            ...
                                            <MenuItem onClick={handleClose}>
                                                <a role='buttton' onClick={()=>addToReadingList(story.id)}>Add to Reading list</a>
                                            </MenuItem>
                                            <MenuItem onClick={handleClose}>
                                                <a>Share</a>
                                            </MenuItem>
                                    ...
                                    <div className='col-md-7 accordion' id="accordionExample"> 
                                        <div id={'collapse'+key} className="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                            <div className="card-body">
                                                <img src={baseurl+story.image} className='card-img-top'/>
                            ...
                            return(
                             <article className="media content-section">
                                ...
                                <div className='row justify-content-left'>
                                    <div className='col-2' >
                                        <img  className="rounded-circle article-img" src={baseurl+story.editor.photo}/>
                                    </div>
                                    <div className="article-metadata col-9" style={{color: '#012559'}}>
                                        <b className="mr-2">{story.editor.name}</b><br/>
                                        <small className="text-muted">27-03-2022</small>
                                    </div>
                                </div>
                                <div className="media-body">
                                  <h3 style={{color: '#012559'}}>{story.title}</h3>
                                  <p style={{textAlign: 'justify'}}>{story.editor.bio}
